...
const _hoisted_9 = /* @__PURE__ */ createStaticVNode('<div class="w-[86.18%] flex mt-[140px] z-10 animate__animated animate__slideInUp" data-v-278a6a5f><div class="flex flex-col bg-[rgb(42,39,61)] w-px" data-v-278a6a5f><div class="bg-white min-h-[24px] mt-[62px] mb-[104px]" data-v-278a6a5f></div></div><div class="bg-gridient transition bg-[center_center] bg-100% 100% bg-no-repeat w-[310px] pt-[22px] pr-[26px] pb-11 pl-[26px] flex flex-col gap-y-4" data-v-278a6a5f><svg class="w-6 h-6" data-v-278a6a5f><use href="#Panel" data-v-278a6a5f></use></svg><h2 class="font-semibold text-[24px] leading-none font-[&#39;RobotoRegular&#39;] text-white tracking-[-0.24px]" data-v-278a6a5f> Fast panel </h2><h5 class="font-normal text-[16px] leading-[1.37] font-[&#39;RobotoRegular&#39;] text-[rgb(124,135,142)] tracking-[-0.16px]" data-v-278a6a5f> Instantaneous chat with any AI at your fingertips. </h5></div><div class="flex flex-col bg-[rgb(42,39,61)] w-px" data-v-278a6a5f><div class="bg-white min-h-[24px] mt-[62px] mb-[104px]" data-v-278a6a5f></div></div><div class="bg-gridient transition w-[310px] pt-[22px] pr-[26px] pb-11 pl-[26px] flex flex-col gap-y-4" data-v-278a6a5f><svg class="w-6 h-6" data-v-278a6a5f><use href="#group" data-v-278a6a5f></use></svg><h2 class="font-semibold text-[24px] leading-none font-[&#39;RobotoRegular&#39;] text-white tracking-[-0.24px]" data-v-278a6a5f> AI/human group </h2><h5 class="font-normal text-[16px] leading-[1.37] font-[&#39;RobotoRegular&#39;] text-[rgb(124,135,142)] tracking-[-0.16px]" data-v-278a6a5f> Seamless integration of artificial intelligence and human expertise. </h5></div><div class="flex flex-col bg-[rgb(42,39,61)] w-px" data-v-278a6a5f><div class="bg-white min-h-[24px] mt-[62px] mb-[104px]" data-v-278a6a5f></div></div><div class="bg-gridient transition w-[310px] pt-[22px] pr-[26px] pb-11 pl-[26px] flex flex-col gap-y-4" data-v-278a6a5f><svg class="w-6 h-6" data-v-278a6a5f><use href="#Cooperative" data-v-278a6a5f></use></svg><h2 class="font-semibold text-[24px] leading-none font-[&#39;RobotoRegular&#39;]" data-v-278a6a5f> Cooperative bot </h2><h5 class="font-normal text-[16px] leading-[1.37] font-[&#39;RobotoRegular&#39;] text-[rgb(124,135,142)] tracking-[-0.16px]" data-v-278a6a5f> Collaborative bot-building revolutionizing knowledge exchange and project management. </h5></div><div class="flex flex-col bg-[rgb(42,39,61)] w-px" data-v-278a6a5f><div class="bg-white min-h-[24px] mt-[62px] mb-[104px]" data-v-278a6a5f></div></div><div class="bg-gridient transition w-[310px] pt-[22px] pr-[26px] pb-11 pl-[26px] flex flex-col gap-y-4" data-v-278a6a5f><svg class="w-6 h-6" data-v-278a6a5f><use href="#botHub" data-v-278a6a5f></use></svg><h2 class="font-semibold text-[24px] leading-none font-[&#39;RobotoRegular&#39;] text-white tracking-[-0.24px]" data-v-278a6a5f> Bot hub </h2><h5 class="font-normal text-[16px] leading-[1.37] font-[&#39;RobotoRegular&#39;] text-[rgb(124,135,142)] tracking-[-0.16px]" data-v-278a6a5f> Exploring and sharing powerful bots within a vibrant community. </h5></div><div class="bg-[rgb(42,39,61)] w-px min-h-[190px]" data-v-278a6a5f></div></div><hr class="bg-[rgb(42,39,61)] w-auto h-px min-h-[1px] mb-[111px]" size="1" data-v-278a6a5f>', 2);
...
const homePage_vue_vue_type_style_index_0_scoped_278a6a5f_lang = "";
const homePage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-278a6a5f"]]);
export {
  homePage as default
};
